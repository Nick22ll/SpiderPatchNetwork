...
class MeshNetwork(nn.Module):
    def __init__(self, patch_feat_dim=18, internal_hidden_dim=256, readout_dim=32, hidden_dim=128, out_feats=15):
        ...
        self.mesh_reader = GraphMeshClassifier(in_dim=readout_dim, hidden_dim=hidden_dim, out_dim=out_feats, dropout=0.5)
...
class GraphMeshClassifier(nn.Module):
    def __init__(self, in_dim, hidden_dim, out_dim, dropout):
        super(GraphMeshClassifier, self).__init__()
